...
--TABLE WILL STORE THE AVERAGE RENTAL PRICE FOR EACH COUNTY
CREATE TABLE COUNTY_ZILLOW_RENTAL_PRICES (ID SERIAL PRIMARY KEY, 
										 STATE VARCHAR,
										 COUNTY VARCHAR,
										 DATE_RECORDED DATE, 
										 AVG_RENT INT,
										 CONSTRAINT STATE_COUNTY_1 
...
CREATE TABLE COUNTY_DEMOGRAPHICS (ID SERIAL PRIMARY KEY, 
										 STATE VARCHAR,
										 COUNTY VARCHAR,
